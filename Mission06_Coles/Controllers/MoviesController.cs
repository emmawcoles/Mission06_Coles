...
namespace Mission06_Coles.Controllers
{
    // MoviesController handles CRUD operations for movies
    // and communicates with the SQLite database through EF Core
    public class MoviesController : Controller
    {
        ...
        // GET: Movies added search functionality to filter movies by title
